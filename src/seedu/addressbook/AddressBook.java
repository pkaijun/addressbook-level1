...
public class AddressBook {
     ...
     */
    // Edited version (Hashmap). The constants given act as the key to retrieve its corresponding data.
    ...
    */
     ...
     */
    private static boolean deletePersonFromAddressBook(HashMap<Integer, String> exactPerson) {
    ...
    private static Optional<HashMap<Integer, String>> decodePersonFromString(String encoded) {
        ...
        HashMap<Integer, String> decodedPerson = new HashMap<Integer, String>();
        decodedPerson.put(PERSON_DATA_INDEX_NAME, extractNameFromPersonString(encoded));
        decodedPerson.put(PERSON_DATA_INDEX_PHONE, extractPhoneFromPersonString(encoded));
        decodedPerson.put(PERSON_DATA_INDEX_EMAIL, extractEmailFromPersonString(encoded));
